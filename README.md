...
Conversational AI Chat (RAG): Users can ask questions in natural language (e.g., "List all contacts from Amazon") to instantly retrieve information from the extracted data.
Persistent Storage: Saves all extracted contacts, creating a searchable and permanent digital database. 
User interactive interface with smooth animations
